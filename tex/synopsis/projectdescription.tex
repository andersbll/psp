...
A realistic energy calculation will require a molecular insight that is beyond the scope of this project. Therefore, we limit ourselves to a perform a distance calculation between all atom pairs. <rant om hvorfor distance-målet er ok?>.
