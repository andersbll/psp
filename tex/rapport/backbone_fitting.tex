The first part of our all-atom fitting algorithm is concerned about fitting the protein backbone to the given \Ca-trace ignoring side-chain conformations.
