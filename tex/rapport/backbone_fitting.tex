...
Finally, \cite{wedemeyer1999exact} has proposed a method for solving loop closures with 6 DOFs in closed form by reducing the problem to extracting roots of a polynomial.
