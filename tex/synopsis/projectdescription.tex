...
center of each amino acid, this is called the $C-\alpha$ atom. The
largest variability of the protein structure is found in the angles
between the individual $C-\alpha$ atoms. Thus, the approach taken by
the algorithms team at our department is to describe the protein
structure solely by the $C-\alpha$ atoms, in the attempt to do protein
