...
\fixme{vi vil vel også undersøge andre ting?}
...
acid, this is called the $C_\alpha$ atom. The largest variability of
the protein structure is found in the angles between the individual
$C_\alpha$ atoms. Thus, the approach taken by the algorithms team at
...
conformation unstable. At worst an added side chain can collide
