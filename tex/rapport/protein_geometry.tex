...
protein descriptors contained errors. Our final data set consists of
...
\end{figure}
\fixme{Skift til en ordentlig skrifttype på figuren af Lysine}
...
store its side chain in a coordinate system that has \Ca\ as origo and
