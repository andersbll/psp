...
\vspace*{3mm}
\begin{itemize}
\item Must use multipoint \emph{end-effector} to avoid local optimas.

\item Angles are chosen to minimize the sum of distances between C$_\alpha$ in the window.
$$S=||\v{d}_1||+||\v{d}_2||+||\v{d}_3||$$

\item Iterates in both directions
\end{itemize}
