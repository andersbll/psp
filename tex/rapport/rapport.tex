...
\begin{abstract}
  ...
  problem by only including few of the protein molecules. In
  particular, the algorithms group at our department only predicts a
  folding of a $C_\alpha$-trace, thus not including many backbone
  atoms and all side-chain molecules.
