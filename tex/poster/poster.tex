...
\usepackage{palatino}
\usepackage{bera}                     % alternative monospace font
...
\node [fill=shade, rounded corners=10pt, inner sep=30pt]
%\node [draw=black, line width=2pt, rounded corners=10pt, inner sep=30pt]
{
...
%\begin{wrapfigure}{r}{0.5\textwidth}
 \begin{center}
\resizebox{10\TPHorizModule}{!}{\includegraphics{../rapport/figures/protein-torsion-angles.pdf}}
