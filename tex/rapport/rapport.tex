...
\begin{onecolabstract}
  ...
  The first task is to build the protein backbone with all its all
  atoms, not only \Ca-atoms and fit it to the $C_\alpha$-trace we get
  as input. Our implementation of this uses inverse kinematics to ...
  ...
  in proteins from 10 to 1.  \vspace{1cm}
\end{onecolabstract}
]
\tableofcontents*
