...
bond angles and a few torsional angles (see below), but to simplify how we
construct the proteins, we have chosen to use another
...
and using a coordinate system that has $C_\alpha$ as origo \fixme{and
  orientated such that ...}. To calculate these positions we have
again used a set of proteins and taken the mean position of all atoms.
...
$chi$ angle defines the rotation about the $C_\alpha-C_\beta$ bond,
