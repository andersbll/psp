...
The strategy we will pursue, is to use any given $C_\alpha$-trace
generated by their prediction algorithm as target when fitting a model
with all atoms present. The fitting should be conducted, such that it
