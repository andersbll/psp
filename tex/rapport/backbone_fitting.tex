...
For \Ca-atom we select a window of size $w$ along the backbone and perform CCD on the $\phi$ and $\psi$ angles within it.
...
Thus, if the first two amino acids have been placed unfortunately this will be fixed when folding in the opposite direction.
